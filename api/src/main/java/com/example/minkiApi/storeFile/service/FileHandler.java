...
//    public List<StoreFileEntity> parseFileInfo(
//            Long storeId,
//            List<MultipartFile> multipartFiles) throws Exception {
//
//        // 반환을 할 파일 리스트
//        List<StoreFileEntity> fileList = new ArrayList<>();
//
