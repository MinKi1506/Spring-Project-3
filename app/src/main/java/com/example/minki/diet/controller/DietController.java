package com.example.minki.diet.controller;
...
public class DietController {
    ...
    public String updateDiet(@PathVariable Long id, @RequestBody AddDietVo addDietVo){
        String dietEntity = this.dietService.updateDiet(id, addDietVo);
        return "updated";
    }
    ...
    public DietEntity getDiet(@PathVariable Long id){
        DietEntity dietEntity = dietService.getDiet(id);
        return dietEntity;
    }
